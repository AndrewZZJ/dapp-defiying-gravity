...
export const WalletConnectButton: React.FC = () => {
  return (
    <button className="flex gap-2 justify-center items-center p-3 rounded-lg border-[3px] border-stone-900">
      <DollarIcon />
      <span className="text-base leading-4 text-zinc-800">
        Connect your wallet
      </span>
    </button>
  );
